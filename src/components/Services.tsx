...
import { Heart, Cake, Camera, Utensils, Flower2, Music, MapPin, Users, ArrowRight } from "lucide-react";
const Services = () => {
  const services = [{
    icon: Heart,
  ...
  return <section id="services" className="py-20 bg-muted/30">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {services.map((service, index) => <Card key={index} className="bg-card border-border hover:shadow-lg transition-shadow duration-300">
              ...
              <CardContent className="pt-0">
                <ul className="space-y-2 mb-6">
                  {service.features.map((feature, featureIndex) => <li key={featureIndex} className="flex items-center text-sm text-muted-foreground font-body">
